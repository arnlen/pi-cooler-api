...
class TemperaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create temperature" do
    assert_difference('Temperature.count') do
      post temperatures_url, params: { temperature: { pi_name: @temperature.pi_name, reading: @temperature.reading } }
    end
  ...
  test "should update temperature" do
    patch temperature_url(@temperature), params: { temperature: { pi_name: @temperature.pi_name, reading: @temperature.reading } }
